const myId = 'https://us-central1-involvement-api.cloudfunctions.net/capstoneApi/apps/pEISiLJvLymH65NIR0wE/comments/';
...
const displayComments = (json) => {
  ...
  if (json.error) {
    ...
    firstComment.textContent = 'No recent Comments';
