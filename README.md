...
# 📖 [Get Movies] <a name="about-project"></a>

**Get Movies** is a project to showcase Top Movies. Further in this project we are going to work with an API, we are going to create the home page and a popup window for more info.
...
```sh
  cd my-folder
  git clone https://github.com/GhausAliKhan/JavaScript-Capstone.git
...
Run Command to install related packages:
...
- Add more webpages such as Book Tickets Page and Favorites.
